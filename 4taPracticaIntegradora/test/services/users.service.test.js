...
import Users from '../../src/dao/dbManagers/users.manager.js';
...
describe('Users service', () => {
    ...
    it('Debería retornar el usuario por email asdfs', async () => {
        sinon.stub(usersService.usersRepository, 'getByEmail').returns(null);
