...
const login = async (req, res) => {
    // Implementar un contador de intentos de sesión, primero identificar la IP del usuario que esta haciendo las peticiones, lo colcamos en un blacklist temporal 10 min A07
    ...
    //El secret para firmar nuestro jwt debe estar como variable de ambiente A05
    const token = jwt.sign(user.toObject(),'C0DerSecret',{expiresIn:30});
    //El token expira en 30 segundos pero puede sguir navengando porque la cookie no tiene tiempo de expiración A01
