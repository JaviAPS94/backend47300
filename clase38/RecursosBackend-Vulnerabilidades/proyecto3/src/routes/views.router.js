...
router.get('/profile/:uid', authenticationMiddleware ,async(req,res)=>{
    //Validar el uid del usuario para que unicamente puede ver información de su perfil
    //Si el uid le corresponde al usuario logueado (JWT), solo en ese caso podemos ver el perfil A01
